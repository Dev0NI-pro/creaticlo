    ...
    html: `
      <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; padding: 40px 20px; color: #262626;">
        ...
        <div style="text-align: center; margin-bottom: 40px;">
          <img src="https://creaticlo.netlify.app/logo.svg" alt="Creaticlo" style="height: 48px;" />
          <p style="color: #a3a3a3; font-size: 12px; text-transform: uppercase; letter-spacing: 3px; margin-top: 8px;">Atelier de couture</p>
        </div>

        <!-- Message principal -->
        <div style="text-align: center; margin-bottom: 40px;">
          <p style="color: #ec4899; font-size: 12px; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 16px;">Confirmation de réception</p>
        ...
        <!-- Récap -->
        <div style="background: #fdf2f8; border-radius: 12px; padding: 24px; margin-bottom: 40px;">
          <p style="color: #ec4899; font-size: 12px; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 16px;">Récapitulatif de votre demande</p>
          <p style="color: #737373; font-size: 14px; line-height: 1.8; margin: 0;">${message}</p>
        </div>

        <!-- Footer -->
        <div style="text-align: center; border-top: 1px solid #f5f5f5; padding-top: 32px;">
          <p style="color: #a3a3a3; font-size: 12px; line-height: 1.8;">
